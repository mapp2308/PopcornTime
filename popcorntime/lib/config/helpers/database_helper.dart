...
class DatabaseHelper {
  static final DatabaseHelper _instance =
      DatabaseHelper._internal(); // Implementación de Singleton
  factory DatabaseHelper() =>
      _instance; // Permite acceder a la única instancia de DatabaseHelper
  ...
  Future<Database> _initDatabase() async {
    String path = join(await getDatabasesPath(),
        'app_bd.db'); // Obtiene la ruta de la base de datos
